...
#4/28/2014
rm(list = ls())
setwd("C:/Users/Waters/Dropbox (MERLAB)/CESRF_RAD_samples/RAD_DATA/Final_Analysis/Final_Analysis_4405_mapped_loci/NeEstimator/FINAL_Ne_estimates/All_loci_single_cohorts")
#################
...
#####Charlie code to filter full Burrow's file for only comparisons between loci on different Chromosomes
##Tried to write a function but had some trouble so I did the longer version
install.packages("plyr")
library(plyr)


###Import cleaned burrows files from NeEstimator and cleaned by Wes's python script
bur_1998<-read.table("clean_All_loci_single_cohorts_1998_genepopBur.txt",header=TRUE,sep="")
bur_2002INT<-read.table("clean_All_loci_single_cohorts_2002INT_genepopBur.txt",header=TRUE,sep="")
bur_2002SEG<-read.table("clean_All_loci_single_cohorts_2002SEG_genepopBur.txt",header=TRUE,sep="")
bur_2006INT<-read.table("clean_All_loci_single_cohorts_2006INT_genepopBur.txt",header=TRUE,sep="")
bur_2006SEG<-read.table("clean_All_loci_single_cohorts_2006SEG_genepopBur.txt",header=TRUE,sep="")
bur_2010INT<-read.table("clean_All_loci_single_cohorts_2010INT_genepopBur.txt",header=TRUE,sep="")
bur_2010SEG<-read.table("clean_All_loci_single_cohorts_2010SEG_genepopBur.txt",header=TRUE,sep="")
