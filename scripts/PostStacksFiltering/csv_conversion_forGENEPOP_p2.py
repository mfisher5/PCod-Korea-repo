...
infile = open('../../stacks_b7_wgenome/batch_7.MBCorrectedGenotypes_filteredMAF_filteredIndivids30_filteredLoci_filteredHWE.txt', 'r')
genepop = open('../../stacks_b7_wgenome/batch_7_MBCorrectedGenotypes_filteredMAF_filteredIndivids30_filteredLoci_filteredHWE.gen', 'w')
genepop.write('# Batch 7 Korea Pacific Cod Fully Filtered Genepop - MB Corrected Genotypes\r\n')
