...
for mystring in genotypes_file:		# Read in each line in the file as a string
	if count == 0:
		...
		JinhaeBay07 = stripped_string.split(' ')[158:202]
		JinhaeBay08 = stripped_string.split(' ')[202:248]
		Boryeong07 = stripped_string.split(' ')[248:272]
		Geoje14 = stripped_string.split(' ')[272:307]
