...
parser.add_argument("-pop", "--pops", help="string of population names, in quotation marks (separate each name with a space, not a comma). make sure this is in the same order as the populations listed in the .INF output file! (aka the order of your populations in your pop map file)")
