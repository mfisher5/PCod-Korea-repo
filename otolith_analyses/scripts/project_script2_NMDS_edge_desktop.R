...
## k = 3
stressplot(object=odata_edge.nmds3, lwd=2)
...
plot(odata_edge.nmds3, xaxt = "n", yaxt = "n", xlab = "", ylab = "", main = "NMDS\nMicrochemistry from Otolith Edge")
## set colors for points based on sampling site
...
## add ellipses
ordiellipse(odata_edge.nmds3, odata_combo$SiteYear, col=c("darkorange", "gold2", "#8dd3c7", "#80b1d3", "#bebada", "#b3de69", "#fb8072"), kind = "sd", lty = 2, lwd = 1.5)


## fit elements to nmds
elements.fit <- envfit(odata_edge.nmds3 ~ B11.e + Ba138.e + Li7.e + Mg24.e + Mn55.e + Pb208.e + Sr88.e + Zn66.e, data = odata_combo)
